...
const products = [
  {
    ...
    detail: "100ml + 30ml Mini · Steam Distilled · All Skin Types",
    wa: WA_BASE + "Rose%20Ras",
    video: "/rose-ras-video.mp4",
    image: "/rose-ras-product.png",
    href: "/products/rose-ras",
  },
  {
    id: "saffrona",
      ...
      <div className="relative overflow-hidden" style={{ borderRadius: "2px" }}>
        ...
        <div className="px-7 py-8" style={{ backgroundColor: "#FDFAF4" }}>
          ...
          <div className="flex items-center gap-5">
            <Link
              href={product.href}
              className="inline-flex items-center gap-2 font-sans text-[10px] tracking-[0.2em] uppercase transition-all duration-250 pb-0.5"
              style={{ color: "#3A5432", borderBottom: "1px solid #3A5432" }}
            >
              Discover →
            </Link>
            <a
